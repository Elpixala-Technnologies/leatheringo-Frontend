...
//     const calculateItemPrice = (productPrice, itemQuantity, productDiscount) => {
...
//         const itemPrice = Math.round(calculateItemPrice(product?.price, quantity, productDiscount));

//         // Calculate the extra discount for each product based on its criteria
...
//                                                 const { product, _id, quantity, itemPrice, isEligibleForExtraDiscount } = data;
...
//                                                                     {isEligibleForExtraDiscount && (
//                                                                         <p className="text-sm text-green-500 font-semibold ml-4">
//                                                                             Eligible for Extra Discount
//                                                                         </p>
//                                                                     )}
