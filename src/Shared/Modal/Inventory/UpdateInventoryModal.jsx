...
const UpdateInventoryModal = ({
  ...
  const { _id, colors, discount, price } = selectedProduct;
          ...
          <div>
            {colors &&
              colors?.map((item, colorIndex) => {
                const { isSizeApplicable, sizes, quantity, images, color } =
                  item;
                return (
                  <div
                    key={colorIndex}
                          ...
                          >
                            <div className="form-control flex gap-4">
                              <div className="flex items-center gap-2 border-2 rounded px-2 my-2">
                                <label htmlFor="sizeof">Size :</label>
                                <input
                                  type="text"
                                  ...
                                  {...register(
                                    `productColors.${colorIndex}.sizes.${sizeIndex}.size`
                                  )}
                                />
                              </div>
                              <div className="flex items-center gap-2  border-2 rounded px-2 my-2">
                                ...
                                <input
                                  ...
                                  className="border-2 my-2 border-gray-300 rounded-md p-2"
                                  {...register(
                                    `productColors.${colorIndex}.sizes.${sizeIndex}.quantity`
                                  )}
                                />
                              </div>
                            </div>
                          ...
                          <div className="flex items-center justify-center w-full">
                            <label className="flex flex-col w-full max-w-xs md:max-w-md h-32 border-4 border-blue-200 border-dashed hover:bg-gray-100 hover:border-gray-300">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handleImageUpload(e, colorIndex)
                                }
                                multiple
                                className="px-4 pb-4"
                              />
