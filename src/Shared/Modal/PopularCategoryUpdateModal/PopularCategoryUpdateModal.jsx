...
const PopularCategoryUpdateModal = ({
  isPopularCategoryModalOpen,
  setIsPopularCategoryModalOpen,
  ...
  const { _id, categories, detail, image } = selectedPopularCategory;
  ...
  const onSubmit = async (data) => {
    ...
    imageUploadData.append("public_id", `${cloud_folder}/${imageFile?.name}`);
        ...
        <div className="flex flex-col w-full gap-4 mx-auto  bg-slate-50 p-6 rounded">
          ...
          >
            ...
            >
              ...
              {categoryData &&
                categoryData.map((categoryResponse) => {
