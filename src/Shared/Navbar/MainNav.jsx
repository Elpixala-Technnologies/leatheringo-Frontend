...
const MainNav = ({ isTransparent, style }) => {
  ...
  const textColor = isTransparent && !isSticky ? 'text-black' : 'text-black';
  ...
  return (
    <div>
      <header
        ...
        style={{ zIndex: "9999", fontSize: "10px", style }}
      >
        <nav
          ...
          <div className="flex items-center mx-2 justify-between w-full md:mx-auto ">
                  ...
                  <li>
                    <div onMouseEnter={() => toggleMegaMenu("shose")}>
                      <div class="relative group">
                        <button class="relative flex gap-2 items-center menu-item uppercase hover:font-semibold transition duration-300 ease-in-out">
                          <span class="group-hover:text-red-500 ">SHOES</span>
                        </button>
                        <span class="h-0 absolute bottom-0 left-0 right-0 border-t-2 border-transparent group-hover:border-red-500 transition-all duration-500"></span>
                      </div>

                      {megaMenuVisible?.shose && (
                        <div
                          className={`mega-menu ${megaMenuVisible.shose ? 'mega-menu-visible' : ''}`}
                          onMouseLeave={() => toggleMegaMenu("shose")}
                          onMouseEnter={() => toggleMegaMenu("shose")}
                        >
                          <div
                            className={` text-black bg-white container mx-auto  border z-50 absolute top-[100%] rounded py-2 px-2 opacity-100 h-[100vh] left-0 right-0`}
                          >
                                ...
                                <div>
                                  <div className="flex gap-2 ">
                                    <div className="h-full  px-2 ">
                                      <h1 className="text-[1rem] font-bold px-4 mt-2">Trending</h1>
                                      <div className="flex flex-col px-4">
                                        <div className="group/edit relative hover:overflow-visible  group-hover/item:visible">
                                          <button className="relative  cursor-pointer flex gap-2 text-[12px] items-center  upercase   hover:font-semibold  transition duration-300 ease-in-out">
                                            <Link
                                    ...
                                    <div className="h-full  px-2">
                                      <h1 className="text-[1rem] font-bold px-4 mt-2">New Arrival</h1>
                                      <div className="flex flex-col px-4">
                                        <div className="group/edit relative hover:overflow-visible  group-hover/item:visible">
                                          <button className="relative  cursor-pointer flex gap-2 text-[12px] items-center  upercase   hover:font-semibold  transition duration-300 ease-in-out">
                                            <Link
                                    ...
                                    <div className="h-full px-2">
                                      <h1 className="text-[1rem] font-bold px-4 mt-2">Popular</h1>
                                      <div className="flex flex-col px-4">
                                        <div className="group/edit relative hover:overflow-visible  group-hover/item:visible">
                                          <button className="relative  cursor-pointer flex gap-2 text-[12px] items-center  upercase   hover:font-semibold  transition duration-300 ease-in-out">
                                            <Link
                                      ...
                                      productData && productData.slice(0, 2).map((product) => {
                                        return (
                                          <div className=" mt-2">
                                                ...
                                                <div className="productImage">
                                                  <div className="h-menu border rounded-t-[0.6rem] overflow-hidden relative">
                                                    <img
                                                      ...
                                                      alt="First Image"
                                                      className="h-[300px] w-[360px] object-cover duration-200"
                                                    />
                                                    <img
                                                      src={product?.colors[0]?.images[1]}
                                                      alt="Second Image"
                                                      className="hover-img absolute top-0 left-0 h-[300px] w-[360px] object-cover duration-300"
                                                    />
                                                  </div>
                                                </div>
                                              </Link>
                                            ...
                                            <div className="mt-2">
                                              <p className="text-[13px] font-semibold text-gray-400">{product?.brand}</p>
                                              <Link href={`/product?id=${product.id}`} className="text-[1.2rem] font-bold">
                                                {product.name}
                                              </Link>
                                            </div>
                                          </div>
            ...
            >
              ...
              >
                ...
                div className={`${textColor}`}>
                  {profileToggle && (
                    <div className="absolute right-0 w-60 px-5 py-3 dark:bg-gray-800 bg-white rounded-lg shadow border dark:border-transparent mt-2">
                      <ul
                      ...
                      >
                        {!userEmail ? (
                          <>
                            <Link
                              href="/auth/login"
                              className={`${textColor} flex items-center text-black  gap-2 border-common-btn `}
                            >
                              <FaUserAlt /> SignIn
                            </Link>
                          </>
                      ...
                      <div className="flex gap-4 items-center mt-4">
                        <Link href={'/facebook.com'}>
                          <FaFacebook className={`${textColor} text-[1.5rem]`} />
                        </Link>
                        <Link href={'/facebook.com'}>
                          <FaInstagram className={`${textColor} text-[1.5rem]`} />
                        </Link>
                        <Link href={'/facebook.com'}>
                          <FaLinkedin className={`${textColor} text-[1.5rem]`} />
                        </Link>
                      </div>
                    </div>
                  )}
            ...
            <div
              className={`${open ? "top-0 left-0" : "top-[-250%]"
                } duration-300 w-full overflow-x-hidden overflow-y-scroll fixed bg-white h-screen top-0 p-4 text-black `}
              style={{ zIndex: 1000 }}
            >
              <button className="float-left" onClick={() => setOpen(!open)}>
                <AiOutlineClose className="text-[1.5rem] mt-2" />
              </button>
              ...
              <hr className='mt-2'/>
              <ul className="flex flex-col gap-6 mt-6  justify-center text-center">
                <li onClick={() => {
                  setAON(!aOn)
                  setAON2(false)

                }} className={` ${aOn || "w-[100%] mx-auto "}`}>
                  <div className="w-full flex justify-center gap-4 items-center text-[14px] font-semibold"><Link href="/">SHOES</Link> <span className="text-xl">{aOn ? <>-</> : <>+</>}</span> </div>
                  <div className={`${aOn ? 'h-[70vh] p-4 overflow-y-scroll mt-3' : 'h-[0px] '} rounded-lg bg-[white] text-black duration-300 overflow-hidden`}>
                    <ul className="border-t">
                      <div className="flex flex-col  gap-4">
                        <div>
                          <div className="flex gap-2 flex-col">
                            <div className="h-full  px-2 ">
                              <h1 className="text-[16px] uppercase font-bold px-4 mt-2">Trending</h1>
                              <div className="flex flex-col px-4">
                                <Link
                                  href={`/product?categoryName=${encodeURIComponent("Formal")}`}
                                  className="text-[14px] uppercase my-2"
                                >
                                  Formal
                                </Link>
                                <Link
                            ...
                            <div className="h-full  px-2">
                              <h1 className="text-[16px] uppercase font-bold px-4 mt-2">New Arrival</h1>
                              <div className="flex flex-col px-4">
                                <Link
                                  href={`/product?categoryName=${encodeURIComponent("Chelsea Boots")}`}
                                  className="text-[14px] uppercase my-2"
                            ...
                            <div className="h-full px-2">
                              <h1 className="text-[16px] uppercase font-bold px-4 mt-2">Popular</h1>
                              <div className="flex flex-col px-4">
                                <Link
                                  href={`/product?categoryName=${encodeURIComponent("Single Monk")}`}
                                  className="text-[14px] uppercase my-2"
                ...
                <li onClick={() => setOpen(!open)} className="text-[14px] font-semibold">
                  <Link href="/">HOME</Link>
                </li>
                <li onClick={() => setOpen(!open)} className="text-[14px] font-semibold uppercase">
                  <Link
                    href={`/product?categoryName=${encodeURIComponent("Bags")}`}
              ...
              <div className="">
                      ...
                      >
                        {!userEmail ? (
                          <>
                            <Link
                              href="/auth/login"
                              className={`${textColor} flex items-center text-black  gap-2  text-[16px]`}
                            >
                              SignIn
                            </Link>
                          ...
                          <div className="flex flex-col gap-2">
                            {isAdmin && (
                              <Link
                                href="/dashboard"
                                className={`${textColor} flex items-center text-black  gap-2 uppercase text-[14px]`}
                              >
                                <FaMicrosoft /> Dashboard
                              </Link>
                            )}
                      ...
                      <div className="flex gap-4 justify-center  items-center mt-[1rem]">
                        <Link href={'/facebook.com'}>
                          <FaFacebook className={`${textColor} text-[1.5rem]`} />
                        </Link>
                        <Link href={'/facebook.com'}>
